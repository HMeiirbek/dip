-- Restore security tables required by AuthService/SecurityService (auth/register, auth/login).
-- These were dropped by 20260309224943_new but the backend still uses them via raw SQL.
